...
public class Area {
	...
	public boolean overlap(Area area) {
		return area.world == this.world && ! (
			area.coords[0] > this.coords[3] || area.coords[3] < this.coords[0] ||
			area.coords[1] > this.coords[4] || area.coords[4] < this.coords[1] ||
			area.coords[2] > this.coords[5] || area.coords[5] < this.coords[2]
		);
	}
	...
	public boolean equals(Area area) {
		return area.world == this.world &&
			area.coords[0] == this.coords[0] &&
			area.coords[1] == this.coords[1] &&
			area.coords[2] == this.coords[2] &&
			area.coords[3] == this.coords[3] &&
			area.coords[4] == this.coords[4] &&
			area.coords[5] == this.coords[5];
	}
